...
typedef struct _RmaMultiInputTable {
    ...
    struct _RmaMultiInputTable * I937;
} RmaMultiInputTable;
...
typedef struct {
    ...
    U  I1022;
    U  I1023;
    HsimSignalMonitor  * I1024;
    RP  I1025;
    RmaTimeStamp64  I1026;
    U  I1027;
    RmaTimeStamp64  I1028;
    U  I1029;
    UB  I1030 :1;
    UB  I1031 :1;
    RP  I1032;
...
typedef struct {
    U  I728;
    U  I736;
    RmaThreadSchedCompiledLoads  * I1046;
...
typedef struct {
    ...
    US  I1107;
    US  I1108;
    RemoteDbsedLoad   I1109[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I908;
    struct TableAssign_ * I819;
    U  I5;
    U  I1111 :1;
    U  I1112 :1;
    U  I1113 :2;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I908;
    struct TableAssignLayoutOnClk_ * I819;
    U  I5;
    U  I1111 :1;
    U  I1112 :1;
    U  I1113 :2;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I908;
    struct TableAssignLayoutOnClkOpt_ * I819;
    U  I1129;
    U  I1111 :1;
    U  I1112 :1;
    U  I1113 :2;
    ...
    U  I1124 :1;
    U  I932 :9;
    RmaSeqPrimOutputOnClkOpt  I1126;
    RmaSeqPrimOutputEblkData  I1130;
...
typedef struct RmaNonEdgeLoadHdr1_ {
    ...
    UB  I1198;
    UB  I1008;
    RmaNonEdgeLoadData1  * I1091;
    RmaNonEdgeLoadData1  * I819;
    RP  I1199;
    void * I1200;
} RmaNonEdgeLoadHdr1;
...
typedef struct RmaChildClockPropList1_ {
    RmaChildClockProp  * I1091;
    RmaChildClockProp  * I819;
...
struct futq_slot1 {
    U  I776;
    struct futq_slot2  I777[32];
};
struct futq_info {
    scalar  * I771;
    U  I772;
    U  I773;
    struct futq_slot1  I774[32];
};
struct futq {
    struct futq * I760;
    struct futq * I762;
...
struct dummyq_struct {
    ...
    struct futq * I1235;
    struct futq * I1236;
    struct sched_table * I1237;
    struct futq_info * I1239;
...
void  hs_0_M_3_0__simv_daidir (UB  * pcode, vec32  * I1038, U  I943);
